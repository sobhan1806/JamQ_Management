...
class LoginReport extends StatefulWidget {
  ...
  LoginReport(this.UserNameResponse);
  LoginReport.none();
                                        ...
                                        Padding(padding:EdgeInsets.only(right: 125),
                                          child: Center(
                                            child: Container(
                                              ...
                                              height: 20,
                                              child: Center(
                                                child: new Text(loginInformation[index]["RlReport"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                              ),
                                            ),
                                          ),
                                        ),
