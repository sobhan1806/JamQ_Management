...
class InviteLog extends StatefulWidget {
  var UserNameResponse;
  InviteLog(this.UserNameResponse);
  InviteLog.none();

  @override
  State<StatefulWidget> createState() {
    return InviteLogState();
  }
}

class InviteLogState extends State<InviteLog> {
  final SearchTextBox = TextEditingController();
  var appscaffold;
  Future loadfuture;
  List inviteInformation;
  bool IsSearch = false;
              ...
              child: Stack(
                  children: [
                    Padding(padding: EdgeInsets.only(left: 10),
                      child: Row(
                        children: [
                          Padding(padding: EdgeInsets.only(right: 1120, top: 158),
                            child:
                            Container(
                              width: 100,
                              height: 30,
                          ...
                          Padding(padding: EdgeInsets.only(right: 10, top: 158),
                            child:
                            Container(
                              width: 100,
                              height: 30,
                    ...
                    Padding(padding: EdgeInsets.only(right: 665, top: 80),
                      child: new Text("گزارشات دعوت به اپلیکیشن", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                    ),// عنوان صفحه
                    Padding(padding: EdgeInsets.only(right: 490, top: 160),
                      child: InkWell(
                          child: Container(
                            width: 100,
                            height: 30,
                          ...
                          onTap: (){
                            ...
                            GetInviteLogByUserName();
                          }
                      ),
                    ), // دکمه جستجو
                    Padding(padding: EdgeInsets.only(left: 370,right: 600, top: 150),
                      child: Card(
                    ...
                    Padding(padding: EdgeInsets.only(left: 370, right: 600, top: 230),
                      child:
                      ListView(children: [
                        Card(
                          child: Container(
                            ...
                            Column(
                                children: [
                                  Row(children: [
                                    ...
                                    Padding(padding: EdgeInsets.only(right: 75, top: 5),
                                      child: new Text("تاریخ دعوت", style: new TextStyle(color: Colors.white, fontFamily: 'IRANSans', fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                                    Padding(padding: EdgeInsets.only(right: 60, top: 5),
                                      child: new Text("دعوت توسط", style: new TextStyle(color: Colors.white, fontFamily: 'IRANSans', fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                                  ]),
                                ]),
                          ),
                    ...
                    Padding(padding: EdgeInsets.only(left: 370, right: 600, top: 280),
                      child: Container(
                        width: width,
                        height: 350,
                        child: new ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount: inviteInformation.length,
                                      ...
                                      children: [
                                        Padding(padding:EdgeInsets.only(right: 17),
                                          child: Container(
                                            width: 90,
                                            height: 20,
                                            child: new Text(inviteInformation[index]["ILUserName"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                        Padding(padding:EdgeInsets.only(right: 60),
                                          child: Container(
                                            width: 60,
                                            height: 20,
                                            child: new Text(PersianDate.fromGregorianString(Convertdate(inviteInformation[index]["ILinviteDate"])).toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                        Padding(padding:EdgeInsets.only(right: 60),
                                          child: Container(
                                            width: 90,
                                            height: 20,
                                            child: new Text(inviteInformation[index]["ILinvitedBy"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                      ],
                                    ),
  ...
  GetInviteLog() async{
    print('GetInviteLog Run...');
    try {
      Response response = await Dio().post("http://jamq.ir:3000/Mainuser/GetAllInviteLog");
      if(response.data.toString() != 'InviteLog Does Not Exist!!!'){
        inviteInformation = response.data;
        print('inviteInformation = '+inviteInformation.toString());
  ...
  GetInviteLogByUserName() async{
    print('GetInviteLogByUserName Run...');
    IsSearch = true;
    if(SearchTextBox.text == ''){
      ...
      try {
        ...
        Response response = await Dio().post("http://jamq.ir:3000/Mainuser/GetInviteLogByUserName",options: Options(contentType: 'multipart/form-data'),data:formData);
        if(response.data.toString() != 'InviteLog Does Not Exist!!!'){
