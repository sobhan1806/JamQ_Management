                                        ...
                                        Padding(padding:EdgeInsets.only(right: 85),
                                          child: Card(
                                            child: InkWell(
                                              ...
                                              onTap: (){
                                                Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: FullTextTicket(ticketsInformation[index]["TkUserId"].toString(), UserName.toString()))),(Route<dynamic> route) => false);
                                              },
                                            ),
                                          ),
                                        ),
