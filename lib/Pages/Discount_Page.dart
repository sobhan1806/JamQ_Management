...
class Discount extends StatefulWidget {
  ...
  Discount(this.UserNameResponse);
  Discount.none();
                          ...
                          Padding(padding: EdgeInsets.only(right: 10, top: 85),
                            child: InkWell(
                              ...
                              onTap: (){
                                Navigator.of(context).pushAndRemoveUntil(
                                    MaterialPageRoute(builder: (context) =>
                                    new Directionality(textDirection: TextDirection.rtl, child: CreateDiscount(UserName.toString()))),(Route<dynamic> route) => false);
                              },
                            ),
                          ), // ایجاد تخفیف
                        ],
                                        ...
                                        Padding(padding:EdgeInsets.only(right: 57),
                                          child: Card(
                                            child: InkWell(
                                              ...
                                              onTap: (){
                                                Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: EditDiscount(discountInformation[index]["_id"].toString(), discountInformation[index]["VchCreatedBy"].toString(), UserName.toString()))),(Route<dynamic> route) => false);
                                              },
                                            ),
                                          ),
                                        ),
