              ...
              child: Stack(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(right: 690, top: 80),
                      child: new Text("لیست سوالات", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                    ),// عنوان صفحه
                                        ...
                                        Padding(padding:EdgeInsets.only(right: 70),
                                          child: Card(
                                            child: InkWell(
                                              ...
                                              onTap: (){
                                                Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: EditQuestion(questionsInformation[index]["_id"].toString()))),(Route<dynamic> route) => false);
                                              },
                                            ),
                                          ),
                                        ),
