...
class EditLiveQuestions extends StatefulWidget {
  var QIdResponse, TypeResponse, UserNameResponse;
  EditLiveQuestions(this.QIdResponse, this.TypeResponse, this.UserNameResponse);
                    ...
                    Padding(padding: EdgeInsets.only(right: 800, top: 580),
                      child: InkWell(
                        ...
                        onTap: (){
                          Navigator.of(context).pushAndRemoveUntil(
                              MaterialPageRoute(builder: (context) =>
                              new Directionality(textDirection: TextDirection.rtl, child: LiveQuestions(MatchId, Type, UserName.toString()))),(Route<dynamic> route) => false);
                        },
                      ),
                    ), // بازگشت
                  ]),
