...
class TournamentManagement extends StatefulWidget{
  ...
  TournamentManagement(this.MatchIdResponse, this.QTimeResponse, this.UserNameResponse);
  TournamentManagement.none();

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return TournamentManagementState();
  }

}
class TournamentManagementState extends State<TournamentManagement>{
                  ...
                  children: [
                    ...
                    new Align(alignment: Alignment.topCenter,
                      child: Padding(padding: EdgeInsets.only(right: 250, top: 80),
                        child: new Text("مدیریت تورنمنت", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                      ),// عنوان صفحه
                    ),// عنوان صفحه
                      ...
                      child: Padding(padding: EdgeInsets.only(left: 115, bottom: 110),
                        child: InkWell(
                          ...
                          onTap: (){
                            Navigator.of(context).pushAndRemoveUntil(
                                MaterialPageRoute(builder: (context) =>
                                new Directionality(textDirection: TextDirection.rtl, child: TournamentManagement(MatchId, QTimeTextBox.text.toString(), UserName.toString()))),(Route<dynamic> route) => false);
                          },
                        ),
                      ), // پایان مسابقه
                    ),// مشاهده بازیکنان
          ...
          buttons: [
            DialogButton(
              ...
              onPressed: () => Navigator.of(context).pushAndRemoveUntil(
                  MaterialPageRoute(builder: (context) =>
                  new Directionality(textDirection: TextDirection.rtl, child: TournamentManagement(MatchId, QTimeTextBox.text, UserName.toString()))),(Route<dynamic> route) => false),
              color: Color(0xffD3D3D3),
            )
          ],
        ).show(); // Message
