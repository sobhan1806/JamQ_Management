...
class CreateLiveMatch extends StatefulWidget {
  ...
  CreateLiveMatch(this.nameResponse, this.questioncountResponse, this.playercountResponse, this.answeringtimeResponse, this.UserNameResponse);
                      ...
                      child: InkWell(
                        ...
                        onTap: (){
                          if(NameTextBox.text == '' || QuestionCountTextBox == '' || PlayerCountTextBox.text == '' || AnsweringTimeTextBox.text == ''){
                            ...
                            Navigator.of(context).pushAndRemoveUntil(
                                MaterialPageRoute(builder: (context) =>
                                new Directionality(textDirection: TextDirection.rtl, child: CreateLiveQuestions(NameTextBox.text, int.parse(QuestionCountTextBox.text), int.parse(PlayerCountTextBox.text), int.parse(AnsweringTimeTextBox.text), UserName.toString()))),(Route<dynamic> route) => false);
                          }
                        },
                      ),
                    ), // ادامه
