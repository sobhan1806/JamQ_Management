...
class CreateAdvertises extends StatefulWidget {
  var UserNameResponse;
  CreateAdvertises(this.UserNameResponse);
  CreateAdvertises.none();

  @override
  State<StatefulWidget> createState() {
    return CreateAdvertisesState();
  }
}

class CreateAdvertisesState extends State<CreateAdvertises> {
  ...
  void initState() {
    super.initState();
    _image = AssetImage('assets/images/Advdef.png');
              ...
              child: Stack(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(right: 750, top: 80),
                      child: new Text("ایجاد تبلیغات", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                    ),// عنوان صفحه
                    ...
                    Padding(padding: EdgeInsets.only(right: 365, top: 253),
                    ...
                    Padding(padding: EdgeInsets.only(left: 260,right: 455, top: 250),
                      child: Card(
                        color: Color(0xff9370DB),
                        child: Container(
                          width: width,
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                  fit: FlexFit.loose,
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(inputFormatters: <TextInputFormatter>[LengthLimitingTextInputFormatter(50)], style: TextStyle(color: Colors.white),controller: PlaceTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                    ...
                    Padding(padding: EdgeInsets.only(right: 415, top: 327),
                      child: new Text("URL", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.normal, fontFamily: 'IRANSans', fontSize: 20)),
                    ),// URL
                    Padding(padding: EdgeInsets.only(left: 260,right: 455, top: 322),
                      child: Card(
                        color: Color(0xff9370DB),
                        child: Container(
                          width: width,
                            ...
                            children: <Widget>[
                              new Flexible(
                                  ...
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      ...
                                      child: TextField(inputFormatters: <TextInputFormatter>[LengthLimitingTextInputFormatter(50), WhitelistingTextInputFormatter(RegExp("[a-zA-Z0-9]")), BlacklistingTextInputFormatter.singleLineFormatter], style: TextStyle(color: Colors.white),controller: URLTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                                        decoration: new InputDecoration(border: InputBorder.none, hintText: "", hintStyle: TextStyle(color: Colors.white)),
                                        keyboardType: TextInputType.multiline,
                                        autofocus: true,
                                      ))),
                    ...
                    new Align(
                      ...
                      child: Padding(padding: EdgeInsets.only(left: 63, bottom: 170),
                        child: CircleAvatar(
  ...
  CreateAdvertises() async {
    print('CreateAdvertises Run...');
    if(NameTextBox.text == '' || PlaceTextBox.text == '' || ispic == false){
      Alert(
        context: context,
        type: AlertType.none,
        title: "پیغام",
      ...
      try {
        FormData formData = FormData.fromMap({
          "AdName":NameTextBox.text,
          "AdPlace":PlaceTextBox.text,
          "AdCreatedBy":UserName.toString(),
          "AdAdvertisesURL":URLTextBox.text,
          "AdImage":jsonimg64,
        });
        print('CreateAdvertises Run...1');
        _openLoadingDialog(context);
        Response response = await Dio().post("http://jamq.ir:3000/Ads/SetAdvertise",options: Options(contentType: 'multipart/form-data'),data:formData);
        print(response.data.toString());
        if(response.data.toString() == "Advertises Added!") {
