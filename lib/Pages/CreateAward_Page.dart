...
class CreateAward extends StatefulWidget {
  ...
  CreateAward(this.UserNameResponse);
  CreateAward.none();

  @override
  State<StatefulWidget> createState() {
    return CreateAwardState();
  }
}

class CreateAwardState extends State<CreateAward> {
                              ...
                              new Flexible(
                                  ...
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(inputFormatters: <TextInputFormatter>[LengthLimitingTextInputFormatter(40)], style: TextStyle(color: Colors.white),controller: TypeTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                                        decoration: new InputDecoration(border: InputBorder.none, hintText: "...نوع", hintStyle: TextStyle(color: Colors.grey)),
                              ...
                              new Flexible(
                                  ...
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(inputFormatters: <TextInputFormatter>[LengthLimitingTextInputFormatter(40)], style: TextStyle(color: Colors.white),controller: AmountTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                                        decoration: new InputDecoration(border: InputBorder.none, hintText: "...مبلغ", hintStyle: TextStyle(color: Colors.grey)),
                                        keyboardType: TextInputType.multiline,
                                        autofocus: true,
                                      ))),
                            ],),
  ...
  CreateAward() async {
    ...
    if(TypeTextBox.text == '' || AmountTextBox.text == ''){
      ...
      try {
        ...
        Response response = await Dio().post("http://jamq.ir:3000/Mainapp/CreateAward",options: Options(contentType: 'multipart/form-data'),data:formData);
        print(response.data.toString());
        if(response.data.toString() == 'CreateAward Done!') {
