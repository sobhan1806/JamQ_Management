...
class PanelUsers extends StatefulWidget {
  ...
  PanelUsers(this.UserNameResponse);
  PanelUsers.none();
...
class PanelUsersState extends State<PanelUsers> {
  ...
  List panelInformationn, accessinformation, ACData;
                            ...
                            child: InkWell(
                              ...
                              onTap: (){
                                Navigator.of(context).pushAndRemoveUntil(
                                    ...
                                    new Directionality(textDirection: TextDirection.rtl, child: PanelUsers(UserName.toString()))),(Route<dynamic> route) => false);
                              },
                            ),
                          ), // بارگذاری مجدد
  ...
  GetPanelUsersByUserNamee() async{
    print('GetPanelUsersByUserName Run...');
    ...
    try {
      ...
      Response response = await Dio().post("http://jamq.ir:3000/Management/GetPanelUserByUserName",options: Options(contentType: 'multipart/form-data'),data:formData);
      if(response.data.toString() != 'User Does Not Exist!!!'){
        panelInformationn = response.data;
        print('GetPanelUsersByUserName = '+panelInformationn.toString());
        AccessLevel = panelInformationn[0]["AdmAccessLevel"];
        print('AccessLevel = '+AccessLevel);
        GetOChartByAccessLevel();
        return panelInformationn;
      }else{
        Alert(
          context: context,
          type: AlertType.none,
