...
class QuestionsTypes extends StatefulWidget {
  ...
  QuestionsTypes(this.UserNameResponse);
  QuestionsTypes.none();
                      ...
                      child: Padding(padding: EdgeInsets.only(right: 250, bottom: 20),
                        child: InkWell(
                          ...
                          onTap: (){
                            Navigator.of(context).pushAndRemoveUntil(
                                MaterialPageRoute(builder: (context) =>
                                new Directionality(textDirection: TextDirection.rtl, child: CreateQuestion(UserName.toString()))),(Route<dynamic> route) => false);
                          },
                        ),
                      ...
                      child: Padding(padding: EdgeInsets.only(right: 250, top: 218),
                        child: InkWell(
                          ...
                          onTap: (){
                            Navigator.of(context).pushAndRemoveUntil(
                                MaterialPageRoute(builder: (context) =>
                                new Directionality(textDirection: TextDirection.rtl, child: CreateCategory(UserName.toString()))),(Route<dynamic> route) => false);
                          },
                        ),
                      ), // ایجاد سوالات به صورت تکی
                    ),// ایجاد دسته بندی
