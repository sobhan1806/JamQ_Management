                            ...
                            child: InkWell(
                              ...
                              onTap: (){
                                Navigator.of(context).pushAndRemoveUntil(
                                    ...
                                    new Directionality(textDirection: TextDirection.rtl, child: CreateAward())),(Route<dynamic> route) => false);
                              },
                            ),
                          ), // بازگشت
                        ],
                                      ...
                                      children: [
                                        ...
                                        Padding(padding: EdgeInsets.only(right: 10),
                                          child: InkWell(
                                            ...
                                            onTap: (){
                                              Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: EditAward(awardsInformation[index]["_id"].toString()))),(Route<dynamic> route) => false);
                                            },
                                          ),
                                        ),
                                      ]),
