...
class CreateQuestion extends StatefulWidget {
  ...
  CreateQuestion(this.UserNameResponse);
  CreateQuestion.none();
...
class CreateQuestionState extends State<CreateQuestion> {
  ...
  CreateQuestions() async {
    ...
    if(CategoryTextBox.text == '' || TrueAnswerTextBox.text == '' || DifficultyTextBox.text == '' || TextTextBox.text == '' || TypeTextBox.text == '' || TypeTextBox.text == '' || DescriptiveAnswerTextBox.text == '' || Choice1TextBox.text == '' || Choice2TextBox.text == '' || Choice3TextBox.text == '' || Choice4TextBox.text == ''){
      Alert(
        context: context,
        type: AlertType.none,
        title: "پیغام",
