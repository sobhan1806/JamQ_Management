...
class ApplicationUsers extends StatefulWidget{
  ...
  ApplicationUsers(this.UserNameResponse);
  ApplicationUsers.none();
                                        ...
                                        Padding(padding:EdgeInsets.only(right: 40),
                                          child: Card(
                                            child: InkWell(
                                              ...
                                              onTap: (){
                                                Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: ApplicationUsersInfo(userInformation[index]["PhoneNumber"].toString(), UserName.toString()))),(Route<dynamic> route) => false);
                                              },
                                            ),
                                          ),
                                        ),
