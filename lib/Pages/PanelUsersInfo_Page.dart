...
class PanelUsersInfo extends StatefulWidget {
  var IdResponse, UserNameResponse;
  PanelUsersInfo(this.IdResponse, this.UserNameResponse);
  PanelUsersInfo.none();

  @override
  State<StatefulWidget> createState() {
    return PanelUsersInfoState();
  }
}

class PanelUsersInfoState extends State<PanelUsersInfo> {
  final UserNameTextBox = TextEditingController();
  final CrationDateTextBox = TextEditingController();
  final AccessLevelTextBox = TextEditingController();
  final IsActiveTextBox = TextEditingController();
  final LastLoginTextBox = TextEditingController();
  var Id, UserName;
  bool isactivate;
  var appscaffold;
  Future loadfuture;
              ...
              child: Stack(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(right: 690, top: 80),
                      child: new Text("مشخصات کاربر پنل", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                    ),// عنوان صفحه
                    Padding(padding: EdgeInsets.only(right: 570, top: 150),
                      child: new Text("نام کاربری", style: new TextStyle(color: Colors.deepPurple, fontFamily: 'IRANSans', fontSize: 20)),
                    ),// نام کاربری
                    Padding(padding: EdgeInsets.only(left: 440,right: 655, top: 150),
                      child: Card(
                            ...
                            children: <Widget>[
                              new Flexible(
                                  ...
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(style: TextStyle(color: Colors.white),controller: UserNameTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                    ...
                    Padding(padding: EdgeInsets.only(right: 537, top: 195),
                      child: new Text("تاریخ ثبت نام", style: new TextStyle(color: Colors.deepPurple, fontFamily: 'IRANSans', fontSize: 20)),
                    ),// تاریخ ثبت نام
                    Padding(padding: EdgeInsets.only(left: 440,right: 655, top: 190),
                      child: Card(
                        color: Color(0xff9370DB),
                        child: Container(
                          width: width,
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                  fit: FlexFit.loose,
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(enabled: false, style: TextStyle(color: Colors.white),controller: CrationDateTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                    ...
                    Padding(padding: EdgeInsets.only(right: 530, top: 235),
                      child: new Text("سطح دسترسی", style: new TextStyle(color: Colors.deepPurple, fontFamily: 'IRANSans', fontSize: 20)),
                    ),// سطح دسترسی
                    Padding(padding: EdgeInsets.only(left: 440,right: 655, top: 230),
                      child: Card(
                        color: Color(0xff9370DB),
                        child: Container(
                          width: width,
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                  fit: FlexFit.loose,
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(style: TextStyle(color: Colors.white),controller: AccessLevelTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                                        decoration: new InputDecoration(border: InputBorder.none, hintText: "", hintStyle: TextStyle(color: Colors.white)),
                                        keyboardType: TextInputType.multiline,
                                        autofocus: true,
                                      ))),
                    ...
                    Padding(padding: EdgeInsets.only(right: 580, top: 275),
                      child: new Text("وضعیت", style: new TextStyle(color: Colors.deepPurple, fontFamily: 'IRANSans', fontSize: 20)),
                    ),//وضعیت
                    Padding(padding: EdgeInsets.only(left: 440,right: 655, top: 270),
                      child: Card(
                        color: Color(0xff9370DB),
                        child: Container(
                          width: width,
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                  fit: FlexFit.loose,
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(enabled: false, style: TextStyle(color: Colors.white),controller: IsActiveTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                                        decoration: new InputDecoration(border: InputBorder.none, hintText: "", hintStyle: TextStyle(color: Colors.white)),
                                        keyboardType: TextInputType.multiline,
                                        autofocus: true,
                                      ))),
                    ...
                    Padding(padding: EdgeInsets.only(right: 535, top: 312),
                      child: new Text("آخرین آنلاینی", style: new TextStyle(color: Colors.deepPurple, fontFamily: 'IRANSans', fontSize: 20)),
                    ),// آخرین آنلاینی
                    Padding(padding: EdgeInsets.only(left: 440,right: 655, top: 310),
                      child: Card(
                        color: Color(0xff9370DB),
                        child: Container(
                          width: width,
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              new Flexible(
                                  fit: FlexFit.loose,
                                  child: new Padding(padding: EdgeInsets.fromLTRB(10, 14, 10, 0),
                                      child: TextField(enabled: false, style: TextStyle(color: Colors.white),controller: LastLoginTextBox, textAlign: TextAlign.center, cursorColor: Colors.white,
                                        decoration: new InputDecoration(border: InputBorder.none, hintText: "", hintStyle: TextStyle(color: Colors.white)),
                                        keyboardType: TextInputType.multiline,
                                        autofocus: true,
                                      ))),
                    ...
                    Padding(padding: EdgeInsets.only(right: 710, top: 400),
                      child: InkWell(
                        child: Container(
                          width: 150,
                          height: 30,
                    ...
                    Padding(padding: EdgeInsets.only(right: 710, top: 435),
                      child: InkWell(
                        child: Container(
                          width: 150,
                          height: 30,
                    ...
                    Padding(padding: EdgeInsets.only(right: 710, top: 470),
                      child: InkWell(
                        child: Container(
                          width: 150,
                          height: 30,
  ...
  PanelUserIsBanned() async{
    print('PanelUserIsBanned Run...');
    UserName = widget.UserNameResponse.toString();
    print('info = '+UserName);
    if(panelInformation[0]["AdmIsActivate"] == true){
      isactivate = false;
    }else{
      isactivate = true;
    }
    try {
      ...
      Response response = await Dio().post("http://jamq.ir:3000/Management/PanelUserIsBanned",options: Options(contentType: 'multipart/form-data'),data:formData);
      if(response.data.toString() == 'PanelUserIsBanned Done!'){
        if(isactivate == true){
          ...
          Alert(
            ...
            type: AlertType.none,
            title: "پیغام",
            desc: ".فعال سازی کاربر با موفقیت انجام شد",
            buttons: [
              DialogButton(
                child: Text(
                  "تایید",
          ...
          Alert(
            ...
            type: AlertType.none,
            title: "پیغام",
            desc: ".غیرفعال سازی کاربر با موفقیت انجام شد",
            buttons: [
              DialogButton(
                child: Text(
                  "تایید",
  ...
  EditPanelUser() async{
    ...
    try {
      ...
      _openLoadingDialog(context);
      Response response = await Dio().post("http://jamq.ir:3000/Management/UpdatePanelUser",options: Options(contentType: 'multipart/form-data'),data:formData);
      if(response.data.toString() == 'UpdateIsActivePanelUser Done!'){
        Navigator.pop(context);
        Alert(
          context: context,
          type: AlertType.none,
  ...
  FillInfo() async{
    print('FillInfo Run...');
    try {
      UserNameTextBox.text = panelInformation[0]["AdmUserName"].toString();
      CrationDateTextBox.text = PersianDate.fromGregorianString(Convertdate(panelInformation[0]["AdmCreationDate"])).toString();
      AccessLevelTextBox.text = panelInformation[0]["AdmAccessLevel"].toString();
      IsActiveTextBox.text = IsActivate(panelInformation[0]["AdmIsActivate"]);
      LastLoginTextBox.text = PersianDate.fromGregorianString(Convertdate(panelInformation[0]["AdmLastLogin"])).toString();
    } catch (e) {
      Alert(
        context: context,
        type: AlertType.none,
