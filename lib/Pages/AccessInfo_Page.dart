...
class AccessInfoState extends State<AccessInfo> {
  ...
  FillInfo(var response) async{
    ...
    try {
      ...
      registerCheckBoxValue = ACData[2]["Register"];
      accessCheckBoxValue = ACData[3]["Access"];
      transactionsCheckBoxValue = ACData[4]["Transactions"];
      advertisingCheckBoxValue = ACData[5]["Advertising"];
      tournamentsCheckBoxValue = ACData[6]["Tournaments"];
      unauthorizedwordsCheckBoxValue = ACData[7]["Unauthorizedwords"];
      questionsCheckBoxValue = ACData[8]["Questions"];
      notificationCheckBoxValue = ACData[9]["Notification"];
      ticketsCheckBoxValue = ACData[10]["Tickets"];
      discountsCheckBoxValue = ACData[11]["Discounts"];
