...
class AccessInfoState extends State<AccessInfo> {
  final AccessLevelTextBox = TextEditingController();
  var AccessLevel;
  List accessinformation, accesses, ACData;
  var AccessLavel, Id;
  var appscaffold;
  Future loadfuture;
  ...
  void initState() {
    super.initState();
    loadfuture = GetOChartByAccessLevel();
  }
              ...
              child: Stack(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(right: 730, top: 80),
                      child: new Text("اطلاعات دسترسی", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                    ), // عنوان صفحه
                    ...
                    Padding(padding: EdgeInsets.only(right: 660, top: 590),
                      child:
                      InkWell(child:
                      Container(
                        width: 100,
                    ...
                    Padding(padding: EdgeInsets.only(right: 850, top: 590),
                      child:
                      InkWell(child:
                      Container(
                        width: 100,
  ...
  GetOChartByAccessLevel() async{
    ...
    AccessLevel = widget.AccessLevelResponse.toString();
  ...
  EditOChart() async {
    print('EditOChart Run...');
    Id = accessinformation[0]["_id"].toString();
    print('Id = '+Id);
    if(AccessLevelTextBox.text == ''){
      ...
      try {
        ...
        Response response = await Dio().post("http://jamq.ir:3000/Management/EditOChart",options: Options(contentType: 'multipart/form-data'),data:formData);
        if(response.data.toString() == "EditOChart Done!"){
  ...
  FillInfo(var response) async{
    print('FillInfo Run...');
    try {
      AccessLevelTextBox.text = AccessLevel;
      print('AccessLevelTextBox = '+AccessLevel);
      ...
      tournamentsCheckBoxValue = ACData[5]["Tournaments"];
      unauthorizedwordsCheckBoxValue = ACData[6]["Unauthorizedwords"];
      questionsCheckBoxValue = ACData[7]["Questions"];
      notificationCheckBoxValue = ACData[8]["Notification"];
      ticketsCheckBoxValue = ACData[9]["Tickets"];
      discountsCheckBoxValue = ACData[10]["Discounts"];
      applogintoreportsCheckBoxValue = ACData[11]["Applogintoreports"];
      appinvitationtoreportsCheckBoxValue = ACData[12]["Appinvitationtoreports"];
      aboutusCheckBoxValue = ACData[13]["Aboutus"];
      InAppItemsCheckBoxValue = ACData[14]["Inappitems"];
      AwardsCheckBoxValue = ACData[15]["Awards"];
