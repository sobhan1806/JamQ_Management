...
class FinishTournaments extends StatefulWidget{
  var UserNameResponse;
  FinishTournaments(this.UserNameResponse);
  FinishTournaments.none();

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return FinishTournamentsState();
  }

}
class FinishTournamentsState extends State<FinishTournaments>{
  var appscaffold;
  Future loadfuture;
              ...
              child: Stack(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(right: 690, top: 80),
                      child: new Text("تورنمنت های انجام شده", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                    ),// عنوان صفحه
