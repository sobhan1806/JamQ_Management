...
class CreateTournamentMatch extends StatefulWidget {
  var nameResponse, questioncountResponse, playercountResponse, answeringtimeResponse, UserNameResponse;
  CreateTournamentMatch(this.nameResponse, this.questioncountResponse, this.playercountResponse, this.answeringtimeResponse, this.UserNameResponse);
  CreateTournamentMatch.none();

  @override
  State<StatefulWidget> createState() {
    return CreateTournamentMatchState();
  }
}

class CreateTournamentMatchState extends State<CreateTournamentMatch> {
  var selectedUsState;
                  ...
                  children: [
                    ...
                    new Align(alignment: Alignment.topCenter,
                      child: Padding(padding: EdgeInsets.only(right: 270, top: 80),
                        child: new Text("ایجاد تورنمنت", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                      ),// عنوان صفحه
                    ),// عنوان صفحه
                      ...
                      child: InkWell(
                        ...
                        onTap: (){
                          if(NameTextBox.text == '' || QuestionCountTextBox == '' || PlayerCountTextBox.text == '' || AnsweringTimeTextBox.text == ''){
                            ...
                            Navigator.of(context).pushAndRemoveUntil(
                                MaterialPageRoute(builder: (context) =>
                                new Directionality(textDirection: TextDirection.rtl, child: CreateTournamentQuestions(NameTextBox.text, int.parse(QuestionCountTextBox.text), int.parse(PlayerCountTextBox.text), int.parse(AnsweringTimeTextBox.text), UserName.toString()))),(Route<dynamic> route) => false);
                          }
                        },
                      ),
                    ), // ادامه
