...
class Transactions extends StatefulWidget {
  ...
  Transactions(this.UserNameResponse);
  Transactions.none();
...
class TransactionsState extends State<Transactions> {
              ...
              child: Stack(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(right: 735, top: 80),
                      child: new Text("تراکنش ها", style: new TextStyle(color: Colors.deepPurple, fontWeight: FontWeight.bold, fontFamily: 'IRANSans', fontSize: 25)),
                    ),// عنوان صفحه
                                ...
                                children: [
                                  Row(children: [
                                    Padding(padding: EdgeInsets.only(right: 20, top: 5),
                                      child: new Text("شناسه کاربر", style: new TextStyle(color: Colors.white, fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                                    ...
                                    Padding(padding: EdgeInsets.only(right: 100, top: 5),
                                      child: new Text("پکیج", style: new TextStyle(color: Colors.white, fontFamily: 'IRANSans', fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                                    Padding(padding: EdgeInsets.only(right: 100, top: 5),
                                      child: new Text("قیمت", style: new TextStyle(color: Colors.white, fontFamily: 'IRANSans', fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                                    Padding(padding: EdgeInsets.only(right: 115, top: 5),
                                      child: new Text("تاریخ تراکنش", style: new TextStyle(color: Colors.white, fontFamily: 'IRANSans', fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                                    Padding(padding: EdgeInsets.only(right: 150, top: 5),
                                      child: new Text("کد تخفیف", style: new TextStyle(color: Colors.white, fontFamily: 'IRANSans', fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                                  ]),
                                ]),
                          ),
                    ...
                    Padding(padding: EdgeInsets.only(left: 24,right: 295, top: 280),
                      child: Container(
                        ...
                        child: new ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount: transactionsInformation.length,
                                      ...
                                      children: [
                                        Padding(padding:EdgeInsets.only(right: 15),
                                          child: Container(
                                            width: 100,
                                            height: 20,
                                            child: new Text(transactionsInformation[index]["TCUserId"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                        Padding(padding:EdgeInsets.only(right: 140),
                                          child: Container(
                                            width: 100,
                                            height: 20,
                                            child: new Text(TransactionState(transactionsInformation[index]["TCState"].toString()), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                        Padding(padding:EdgeInsets.only(right: 60),
                                          child: Container(
                                            width: 80,
                                            height: 20,
                                            child: new Text(transactionsInformation[index]["TCPackage"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                        Padding(padding:EdgeInsets.only(right: 40),
                                          child: Container(
                                            width: 80,
                                            height: 20,
                                            child: new Text("تومان" + " " + transactionsInformation[index]["TCPrice"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                        Padding(padding:EdgeInsets.only(right: 88),
                                          child: Container(
                                            width: 100,
                                            height: 20,
                                            child: new Text(PersianDate.fromGregorianString(Convertdate(transactionsInformation[index]["TCCreationDate"])).toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                        Padding(padding:EdgeInsets.only(right: 130),
                                          child: Container(
                                            width: 100,
                                            height: 20,
                                            child: new Text(transactionsInformation[index]["TCVoucher"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                          ),
                                        ),
                                      ],
                                    ),
  ...
  GetTransactions() async{
    print('GetTransactions Run...');
    try {
      Response response = await Dio().post("http://jamq.ir:3000/Transaction/GetTransactions");
      if(response.data.toString() != 'Transaction Does Not Exist!!!'){
        transactionsInformation = response.data;
        print('transactionInformation = '+transactionsInformation.toString());
        GetPanelUsersByUserName();
        return transactionsInformation;
      }else{
        Alert(
          context: context,
          type: AlertType.none,
          title: "پیغام",
          desc: "!!!تراکنشی وجود ندارد",
          buttons: [
            DialogButton(
              child: Text(
                "تایید",
  ...
  GetTransactionsByUserId() async{
    print('GetTransactionsByUserId Run...');
    IsSearch = true;
    if(SearchTextBox.text == ''){
      ...
      try {
        ...
        Response response = await Dio().post("http://jamq.ir:3000/Transaction/GetTransactionsById",options: Options(contentType: 'multipart/form-data'),data:formData);
        if(response.data.toString() != 'Transaction Does Not Exist!!!'){
          Navigator.pop(context);
          transactionsInformation = response.data;
          print('GetTransactionsByUserId = '+transactionsInformation.toString());
          return transactionsInformation;
        }else{
          Navigator.pop(context);
          Alert(
