...
class LiveQuestions extends StatefulWidget {
  var MatchIdResponse, TypeResponse, UserNameResponse;
  LiveQuestions(this.MatchIdResponse, this.TypeResponse, this.UserNameResponse);
  LiveQuestions.none();
                          ...
                          Padding(padding: EdgeInsets.only(right: 1230, top: 85),
                            child: InkWell(
                              ...
                              onTap: (){
                                ...
                                if(Type == true){
                                  Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: LiveTournamentActive(UserName.toString()))),(Route<dynamic> route) => false);
                                }else if(Type == false){
                                  Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: LiveTournament(UserName.toString()))),(Route<dynamic> route) => false);
                                }
                              },
                            ),
                          ), // ازگشت
                                        ...
                                        Padding(padding: EdgeInsets.only(right: 80),
                                          child: InkWell(
                                            ...
                                            onTap: (){
                                              Type = widget.TypeResponse;
                                              if(Type == true){
                                                Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (context) =>new Directionality(textDirection: TextDirection.rtl, child: EditLiveQuestions(livequestionInformation[index]["_id"].toString(), Type, UserName.toString()))),(Route<dynamic> route) => false);
                                              }else{
                                                Alert(
                                                  context: context,
                                                  type: AlertType.none,
