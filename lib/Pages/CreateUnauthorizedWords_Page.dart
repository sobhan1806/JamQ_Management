...
class CreateUnauthorizedWords extends StatefulWidget {
  ...
  CreateUnauthorizedWords(this.UserNameResponse);
  CreateUnauthorizedWords.none();
              ...
              Padding(padding: EdgeInsets.only(right: 730, top: 435),
                child: InkWell(
                  ...
                  onTap: (){
                    Navigator.of(context).pushAndRemoveUntil(
                        MaterialPageRoute(builder: (context) =>
                        new Directionality(textDirection: TextDirection.rtl, child: UnauthorizedWords(UserName.toString()))),(Route<dynamic> route) => false);
                  },
                ),
              ), // لیست
            ]),
