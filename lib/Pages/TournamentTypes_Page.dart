...
class TournamentTypes extends StatefulWidget {
  var UserNameResponse;
  TournamentTypes(this.UserNameResponse);
  TournamentTypes.none();

  @override
  State<StatefulWidget> createState() {
    return TournamentTypesState();
  }
}

class TournamentTypesState extends State<TournamentTypes> {
                ...
                child: Padding(padding: EdgeInsets.only(right: 250, bottom: 100),
                  child: InkWell(
                    ...
                    onTap: (){
                      Navigator.of(context).pushAndRemoveUntil(
                          MaterialPageRoute(builder: (context) =>
                          new Directionality(textDirection: TextDirection.rtl, child: OneVsOneTournament(UserName.toString()))),(Route<dynamic> route) => false);
                    },
                  ),
                ), // لیست سوالات
              ),// مسابقه یک به یک
