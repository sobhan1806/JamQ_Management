...
class AccessList extends StatefulWidget {
  ...
  AccessList(this.UserNameResponse);
  AccessList.none();
...
class AccessListState extends State<AccessList> {
            ...
            body: Center(
              child: Stack(
                  children: [
                    ...
                    Padding(padding: EdgeInsets.only(left: 430, right: 630, top: 230),
                      child:
                      ListView(children: [
                        Card(
                          child: Container(
                                ...
                                children: [
                                  Row(children: [
                                    Padding(padding: EdgeInsets.only(right: 25, top: 5),
                                      child: new Text("سطح دسترسی", style: new TextStyle(color: Colors.white, fontWeight: FontWeight.normal, fontSize: 15)),
                                    ),
                    ...
                    Padding(padding: EdgeInsets.only(left: 430, right: 630, top: 280),
                      child: Container(
                        width: width,
                        height: 350,
                        child: new ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount: accessInformation.length,
                                      ...
                                      children: [
                                        Padding(padding:EdgeInsets.only(right: 18),
                                          child: Container(
                                            ...
                                            height: 20,
                                            child: Center(
                                              child: new Text(accessInformation[index]["OCAccessLevel"].toString(), style: new TextStyle(color: Color(0xff2E0273), fontFamily: 'IRANSans', fontWeight: FontWeight.bold, fontSize: 13)),
                                            ),
                                          ),
                                        ),
                                          ...
                                          child: Card(
                                            child: InkWell(
                                              child: Container(
                                                ...
                                                height: 30,
                                                color: Color(0xff483D8B),
                                                child: Padding(padding: EdgeInsets.only(right: 23, top: 4),
          ...
          buttons: [
            DialogButton(
              ...
              onPressed: () => Navigator.of(context).pushAndRemoveUntil(
                  MaterialPageRoute(builder: (context) =>
                  new Directionality(textDirection: TextDirection.rtl, child: Home(UserName))),(Route<dynamic> route) => false),
              color: Color(0xffD3D3D3),
            )
          ],
        ).show(); // Message
